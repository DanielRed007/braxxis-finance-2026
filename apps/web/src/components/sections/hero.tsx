    ...
    >
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
        ...
        <h1 className="text-6xl md:text-8xl font-bold tracking-tight leading-none mb-6 animate-hero-stagger-1">
          ...
          <br />
          <span className="hero-heading-alt">build wealth faster</span>
        </h1>
        ...
        <div className="flex items-center justify-center gap-4 flex-wrap animate-hero-stagger-3">
          <a
            href="/auth/sign-up"
            className="px-7 py-3 rounded-full font-semibold text-white transition-all duration-200 hover:-translate-y-0.5 hover:brightness-110 hover:shadow-lg"
            style={{
          ...
          <a
            href="/auth/sign-in"
            className="px-7 py-3 rounded-full font-semibold transition-all duration-200 hero-btn-secondary"
          >
            Sign In
          </a>
        </div>
