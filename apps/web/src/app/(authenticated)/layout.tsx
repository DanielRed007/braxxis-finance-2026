...
const NAV_ITEMS = [
  ...
  { label: 'Markets', href: '/dashboard/markets', icon: 'M13 7h8m0 0v8m0-8l-8 8-4-4-6 6' },
  { label: 'Trade', href: '/dashboard/trade', icon: 'M7.5 21L3 16.5m0 0L7.5 12M3 16.5h13.5m0-13.5L21 7.5m0 0L16.5 12M21 7.5H7.5' },
